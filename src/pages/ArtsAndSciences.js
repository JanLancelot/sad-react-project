...
const departmentName = "Arts and Sciences Department";
const deanName = "Arts and Sciences Department Dean";
...
export default function ArtsAndSciences() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const artsAndSciencesDepartmentQuery = query(
        usersRef,
        where("department", "==", "Arts and Sciences Department")
      );
      const usersSnapshot = await getDocs(artsAndSciencesDepartmentQuery);
      ...
      const maritimeDepartmentMeetingsQuery = query(
        ...
        where("department", "in", ["Arts and Sciences Department", "All"])
      );
