...
const secondaryNavigation = [
  { name: 'CS Department', href: '#', current: true },
  { name: 'Department 1', href: '#', current: false },
  { name: 'Department 2', href: '#', current: false },
  { name: 'Department 3', href: '#', current: false },
  { name: 'Department 4', href: '#', current: false },
]
const stats = [
