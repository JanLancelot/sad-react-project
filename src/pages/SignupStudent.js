              ...
              <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
                {showSuccessMessage && createdUserData ? (
                  <div className="relative bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
                    ...
                    <div className="mt-4">
                      <button
                        className="bg-indigo-600 text-white rounded-md px-4 py-2 hover:bg-indigo-500 mr-2"
                    ...
                    {!showAdditionalFields ? (
                      <>
                        ...
                        <div>
                          <button
                            type="button"
                            className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outlinefocus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
