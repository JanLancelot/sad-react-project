...
const secondaryNavigation = [
  ...
  { name: "Hospitality Management and Tourism", href: "/hospitality", current: true },
];

const departmentName = "Hospitality Department";
const deanName = "Hospitality Dean";
...
export default function Hospitality() {
  ...
  const department = "Hospitality Management and Tourism Department";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const hospitalityDepartmentQuery = query(usersRef, where("department", "==", "Hospitality Management and Tourism Department"));
      const usersSnapshot = await getDocs(hospitalityDepartmentQuery);
