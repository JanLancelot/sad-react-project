...
export default function BusinessAdministration() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const businessAdministrationDepartmentQuery = query(
        usersRef,
        where("department", "==", "Business Administration Department")
      );
      const usersSnapshot = await getDocs(
        businessAdministrationDepartmentQuery
      );
      ...
      const maritimeDepartmentMeetingsQuery = query(
        ...
        where("department", "in", ["Business Administration Department", "All"])
      );
