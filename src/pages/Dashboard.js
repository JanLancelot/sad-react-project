...
const meetings = [
  {
      ...
      date: 'March 8th, 2024',
      time: '5:00 AM',
      datetime: '2024-03-08T17:00',
      name: 'IRCITE',
      imageUrl:
          'https://easychair.org/images/cfp-logo/IRCITE2023.jpg?id=15241594',
    ...
    <Layout>
      <main className="lg:pr-96">
        <header className="flex items-center justify-between border-b border-gray-300 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
          <h1 className="text-base font-semibold leading-7 text-gray-800">Upcoming Events</h1>
      ...
      <aside className="bg-white lg:fixed lg:bottom-0 lg:right-0 lg:top-16 lg:w-96 lg:overflow-y-auto lg:border-l lg:border-gray-300">
        <header className="flex items-center justify-between border-b border-gray-300 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
          <h2 className="text-base font-semibold leading-7 text-gray-800">Activity feed</h2>
          ...
          {activityItems.map((item) => (
            <li key={item.commit} className="px-4 py-4 sm:px-6 lg:px-8">
              <div className="flex items-center gap-x-3">
                ...
                <h3 className="flex-auto truncate text-sm font-semibold leading-6 text-gray-800">{item.user.name}</h3>
                <time dateTime={item.dateTime} className="flex-none text-xs text-gray-600">
                  {item.date}
                </time>
              </div>
              <p className="mt-3 truncate text-sm text-gray-500">
                Created new <span className="text-gray-400">{item.projectName}</span> (
